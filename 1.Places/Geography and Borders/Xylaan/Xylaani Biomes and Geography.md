...
---
 ...
 # Biomes
  ...
  ## Rainforest
  - Description
	  - A hot and humid place, storms are brought in by the xylaani bay and high air pressure is held in by the mountains and an ever thick sugar layer. Perspective in this biome is particularly dependent on verticality, with the grand [[{Seraphine port city}]]
  - Important locations
	  - seraphine port city
  - Important 
